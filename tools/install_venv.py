...
"""
Installation script for setting up development virtualenv
"""
        ...
        if HAS_EASY_INSTALL:
            ...
            if not run_command(['which', 'easy_install']):
                die('ERROR: virtualenv not found.\n\n'
                    'Virtualenv is required for development, please install'
...
def print_help():
 ...
 It uses virtualenv to track and manage Python dependencies
 while in development and testing.

 To activate the development virtualenv for the extent of your current shell session
 you can run:
